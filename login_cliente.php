...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['form_type']) && $_POST['form_type'] == 'login') {
    ...
    if (empty($email) || empty($password_ingresada)) {
        ...
        if ($conexion) {
            ...
            $sql = $conexion->prepare("SELECT cliente_id, nombre, password, rol, activo FROM empleados WHERE email = ?");
            ...
            if ($sql === false) {
                ...
                if ($resultado->num_rows === 1) {
                    ...
                    elseif (password_verify($password_ingresada, $empleado['password'])) {
                        // Login correcto
                        $_SESSION['cliente_id'] = $empleado['cliente_id'];
                        $_SESSION['cliente_nombre'] = $empleado['nombre'];
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['form_type']) && $_POST['form_type'] == 'register_cliente') {
            ...
            if ($resultado->num_rows > 0) {
                ...
                $sql = $conexion->prepare("
                    ...
                    (nombre, primer_apellido, segundo_apellido, email, password, 
                     telefono, direccion, ciudad, codigo_postal, fecha_registro, activo)
